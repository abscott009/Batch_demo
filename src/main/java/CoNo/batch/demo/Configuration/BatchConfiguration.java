package CoNo.batch.demo.Configuration;
```
import CoNo.batch.demo.Model.Employee;
import CoNo.batch.demo.Repository.EmployeeRepository;
import CoNo.batch.demo.Service.Designation;
...
public class BatchConfiguration {
    ...
    @Bean
    public Job job(JobBuilder jobBuilderFactory, Step nameStep, Step designationStep) {
    ...
    @Bean
    public Step nameStep(StepBuilder stepBuilderFactory, ItemReader<Employee> csvReader, NameProcessor processor, EmployeeWriter writer) {
    ...
    @Bean
    public Step designationStep(StepBuilder stepBuilderFactory, ItemReader<Employee> repositoryReader, DesignationProcessor processor, EmployeeWriter writer) {
